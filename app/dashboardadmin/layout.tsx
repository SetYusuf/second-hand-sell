...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const isActive = (path: string) => {
    if (path === '/dashboardadmin' && pathname === '/dashboardadmin') {
      return 'active';
    }
    if (path !== '/dashboardadmin' && pathname?.startsWith(path)) {
      return 'active';
    }
    return '';
  };
    ...
    <div className="admin-container">
      <aside className="admin-sidebar">
        ...
        <div className="sidebar-nav-container">
          ...
          <nav className="px-2">
            <a href="/dashboardadmin" className={`nav-item ${isActive('/dashboardadmin')}`}>
            ...
            <a href="/dashboardadmin/admin" className={`nav-item ${isActive('/dashboardadmin/admin')}`}>
              <svg className="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 11c1.657 0 3-1.343 3-3S13.657 5 12 5s-3 1.343-3 3 1.343 3 3 3zm0 2c-2.667 0-8 1.333-8 4v2h16v-2c0-2.667-5.333-4-8-4z" />
              </svg>
              <span className="nav-text">Admin</span>
            </a>
            <a href="/dashboardadmin/user" className={`nav-item ${isActive('/dashboardadmin/user')}`}>
              <svg className="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
              </svg>
              <span className="nav-text">User</span>
            </a>
            <a href="/dashboardadmin/owner" className={`nav-item ${isActive('/dashboardadmin/owner')}`}>
              <svg className="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <span className="nav-text">Owner</span>
            </a>
            <a href="/dashboardadmin/notifications" className={`nav-item ${isActive('/dashboardadmin/notifications')}`}>
              <svg className="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="/dashboardadmin/phone" className={`nav-item ${isActive('/dashboardadmin/phone')}`}>
              <svg className="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="/dashboardadmin/computer" className={`nav-item ${isActive('/dashboardadmin/computer')}`}>
              <svg className="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="/dashboardadmin/book" className={`nav-item ${isActive('/dashboardadmin/book')}`}>
              <svg className="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="/dashboardadmin/service" className={`nav-item ${isActive('/dashboardadmin/service')}`}>
              <svg className="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="/dashboardadmin/product" className={`nav-item ${isActive('/dashboardadmin/product')}`}>
              <svg className="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="/dashboardadmin/settings" className={`nav-item ${isActive('/dashboardadmin/settings')}`}>
              <svg className="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="sidebar-footer">
          ...
          <div className="footer-version">v2.1.0<br />© 2026 Admin Panel</div>
        </div>
      </aside>
          ...
          <div className="header-right">
            <div className="header-user-area">
              <button className="header-user-btn">
                <img className="user-avatar" src="https://ui-avatars.com/api/?name=Admin+User" alt="Admin Avatar" />
              </button>
            </div>
          </div>
        </header>
